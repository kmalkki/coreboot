...
#ifndef __NORTHBRIDGE_INTEL_I915_I915_H__
#define __NORTHBRIDGE_INTEL_I915_I915_H__ 1
...
#define D0F0_MCHBAR_LO		0x44
#define D0F0_PCIEXBAR_LO 	0x48
#define D0F0_DMIBAR_LO 		0x4c
#define D0F0_X60BAR_LO		0x60
...
#define C0R0B00DQST	0x300	/* 72bit */
...
#endif
#define WDLL_RST	0x35a	/* 16bit */
#if 0
#define WDLLBYPMODE	0x360	/* 16bit */
#define C0WDLLCMC	0x36c	/* 32bit */
#endif
#define C0HCTC		0x37c	/*  8bit */
#define C0HCTC2		0x37d	/*  8bit */	/* 3 LSB bits */

#define C1R0B00DQST	0x380	/* 72bit */
