...
static void ide_init(struct device *dev)
{
	...
	printk(BIOS_DEBUG, "i82801fx_ide: initializing... ");
	if (config == NULL) {
		printk(BIOS_ERR, "\ni82801fx_ide: Not mentioned in devicetree.cb!\n");
...
static const struct pci_driver i82801fx_ide __pci_driver = {
	.ops	= &ide_ops,
	.vendor	= PCI_VENDOR_ID_INTEL,
	.device	= PCI_DEVICE_ID_INTEL_82801FB_IDE,	
};
