...
static void sata_init(struct device *dev)
{
	...
	printk(BIOS_DEBUG, "i82801fx_sata: initializing...\n");

	if (config == NULL) {
		printk(BIOS_ERR, "i82801fx_sata: error: device not in devicetree.cb!\n");
		return;
	}
...
static const struct pci_driver i82801fx_sata_driver __pci_driver = {
	.ops	= &sata_ops,
